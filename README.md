...
| **terraform-digitalocean-docker** (this repo) | [`hansohn/terraform-digitalocean`](https://hub.docker.com/r/hansohn/terraform-digitalocean) | Base image plus doctl, the DigitalOcean CLI |
