# Contributing to terraform-digitalocean-docker

Thank you for your interest in contributing to terraform-digitalocean-docker! This document provides guidelines and instructions for contributing to this project.
...
2. Check existing [issues](https://github.com/hansohn/terraform-digitalocean-docker/issues) and [pull requests](https://github.com/hansohn/terraform-digitalocean-docker/pulls)
3. Join discussions in [GitHub Discussions](https://github.com/hansohn/terraform-digitalocean-docker/discussions) if you have questions
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/terraform-digitalocean-docker.git
   cd terraform-digitalocean-docker
   ```
...
- Open a [Discussion](https://github.com/hansohn/terraform-digitalocean-docker/discussions)
- Check existing [Issues](https://github.com/hansohn/terraform-digitalocean-docker/issues)
